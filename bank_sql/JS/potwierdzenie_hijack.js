...
var v4=getCookie("kwota");
     				 ...
     				 document.getElementById("confirmedField").innerHTML="<label for=\"numer_konta\">numer konta: </label>"+v1+"<br><label for=\"nazwa\">nazwa: </label>"+v2+"<br><label for=\"adres\">adres: </label>"+v3+"<br><label for=\"kwota\">kwota: </label> "+v4;
